...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="<?php echo web_root;?>/admin/" class="logo">
      ...
      <span class="logo-mini"><b>Opportunity</b></span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><b>Opportunity Junction</b></span>
    </a>
...
<!-- Control Sidebar Toggle Button -->
 ...
 <div class="modal fade" id="menuModal" tabindex="-1">
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2024 <a href="#">Opportunity Junction</a>.</strong> All rights
    reserved.
  </footer>
